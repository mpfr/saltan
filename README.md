...
For further information, please have a look at the [manpage](https://mpfr.net/man/saltan/7.9-stable/saltan.8.html).
...
$ pwd
/home/mpfr
$ doas rm -rf saltan-7.9-stable/
$ ftp -Vo - https://codeload.github.com/mpfr/saltan/tar.gz/7.9-stable | tar xzvf -
saltan-7.9-stable
saltan-7.9-stable/LICENSE
saltan-7.9-stable/README.md
saltan-7.9-stable/docs
saltan-7.9-stable/docs/saltan.8.html
saltan-7.9-stable/pkg
saltan-7.9-stable/pkg/accept
saltan-7.9-stable/pkg/accept/accepted
saltan-7.9-stable/pkg/reject
saltan-7.9-stable/pkg/reject/banner_exchange
saltan-7.9-stable/pkg/reject/connection_closed_by_authenticating_user
saltan-7.9-stable/pkg/reject/disconnected_from_authenticating_user
saltan-7.9-stable/pkg/reject/disconnecting_authenticating_user
saltan-7.9-stable/pkg/reject/invalid_user
saltan-7.9-stable/pkg/reject/unable_to_negotiate
saltan-7.9-stable/pkg/saltan.conf
saltan-7.9-stable/pkg/saltan.rc
saltan-7.9-stable/src
saltan-7.9-stable/src/Makefile
saltan-7.9-stable/src/saltan.8
saltan-7.9-stable/src/saltan.sh
```

Install daemon, manpage, service script, modules and a sample configuration file.

```
$ cd saltan-7.9-stable/src
$ doas make fullinstall
install -c -o root -g bin -m 555  /home/mpfr/saltan-7.9-stable/src/saltan.sh ...
install -c -o root -g bin -m 444  saltan.8 /usr/local/man/man8/saltan.8 ...
mkdir -p /etc/saltan/{accept,reject}
cp /root/saltan-7.9-stable/src/../pkg/accept/* /etc/saltan/accept
cp /root/saltan-7.9-stable/src/../pkg/reject/* /etc/saltan/reject
install -c -o root -g bin -m 555  /home/mpfr/saltan-7.9-stable/src/../pkg/saltan...
cp /root/saltan-7.9-stable/src/../pkg/saltan.conf /etc/saltan
```
...
```
$ doas rm -rf /etc/saltan ~/saltan-7.9-stable
```
